...
func CopyPasteFromTemplate(rootToSkip, pathUnder string, fileRenamer map[string]string, data any, efs embed.FS) error {

	pathUnder = rootToSkip + pathUnder
	...
	err := readFolders(efs, pathUnder, pathUnder, &ff)
	if err != nil {
		return err
	}
